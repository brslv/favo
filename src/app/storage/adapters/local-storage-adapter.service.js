...
var LocalStorageAdapterService = (function () {
    ...
    LocalStorageAdapterService.prototype.add = function (data) {
        console.log('adds to local storage...');
    };
    LocalStorageAdapterService.prototype.edit = function (id, data) {
        console.log('edits a record from local storage');
    };
    LocalStorageAdapterService.prototype.delete = function (data) {
